...
label4 = Label(master=bovenframe, text="OPEN", fg='white', bg='midnight blue', font=my_font2)
label4.grid(row=1, column=1)

label5 = Label(master=bovenframe, text="Waterpeil:", bg='midnight blue', fg='white', font=my_font2)
label5.grid(row=2, column=2)

label6 = Label(master=bovenframe, text="3M", fg='white', bg='midnight blue', font=my_font2)
